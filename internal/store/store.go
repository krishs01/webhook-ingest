...
// InsertEvent stores the raw delivery. If the event_id already exists the
// insert is silently skipped thanks to the UNIQUE index. The returned bool
// indicates whether a new row was actually created (true) or the event was
// a duplicate (false).
